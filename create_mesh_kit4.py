"""
This scripts creates as mesh which is compatible with the KIT4 data.
...
n_in = 8  # Number of vertices on the electrodes.
n_out = 4  # Number of vertices in gaps.
...
gmsh.write(f"mesh_{n_in}_{n_out}.msh")
